...
<div class="page-title-strip">
    <div>
        <div class="page-name">🤖 AI Oil Analyst</div>
        <div class="page-sub">اسألني بالعربي أو الإنجليزي — 84 دولة · 2020–2026</div>
    </div>
    <span class="page-badge">AI POWERED</span>
</div>
...
if not st.session_state.messages:
    chat_html += """
    <p style="color:#7a9ab8;text-align:center;margin-top:40px;
              font-family:'JetBrains Mono',monospace;font-size:0.78rem;line-height:2.4">
    👋 جرب اسألني:<br>
    <em style="color:#0D8AA6">"أرخص وأغلى 5 دول في البنزين؟"</em><br>
    <em style="color:#0D8AA6">"قارن أوروبا vs الشرق الأوسط"</em><br>
    <em style="color:#0D8AA6">"تأثير 2022 على الأسعار؟"</em><br>
    <em style="color:#0D8AA6">"Which countries have Very High subsidies?"</em>
    </p>"""
...
# ── Quick suggestions ─────────────────────────────────────────────────────────
st.markdown('<div class="section-title" style="margin-top:12px">Quick Questions</div>', unsafe_allow_html=True)
suggestions = [
